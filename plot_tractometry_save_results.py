...
def main():
    ...
    parser.add_argument("--alpha", metavar="a", type=float, help="The desired alpha level (default: 0.05)",
                        default=0.05)
    parser.add_argument("--plot3D", metavar="none|metric|pval|sig_areas", choices=["none", "metric", "pval", "sig_areas"],
    ...
    plot_tractometry_with_pvalue(values, meta_data, all_bundles, selected_bundles, args.output_path,
                                 ...
                                 atlas_path=args.atlas_path, show_color_bar=show_color_bar,
                                 save_csv=args.save_csv, y_range=args.range)
